...
return {
    ...
    keys = {
      ...
      {"<C-b>", "<cmd>TodoTelescope<CR>", mode = "n", opt, desc = "Show Fuzzy Finder by ToDo Comment"},
      {"gr", "<cmd>Telescope lsp_references<CR>", mode = "n", opt, desc = "Show Fuzzy Finder of References"},
      {"<S-g>b", "<cmd>Telescope git_branches<CR>", mode = "n", opt, desc = "Show Fuzzy Finder of Git Branch"},
      ...
      {"<M-b><M-m>", "<cmd>Telescope vim_bookmarks all<CR>", mode = "n", opt, desc = "Show Fuzzy Finder of Bookmarks"},
      {"<M-o><M-l>", "<cmd>Telescope aerial<CR>", mode = "n", opt, desc = "Show Fuzzy Finder of File OutLine"},
      {"<M-k><M-m>", "<cmd>Telescope keymaps<CR>", mode = "n", opt, desc = "Show Fuzzy Finder of Keymaps"},
    },
    config = function()
