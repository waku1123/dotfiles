...
return {
  ...
  event = { "BufReadPre" },
  keys = {
      {"<Leader>/", ":HopPattern<CR>", desc = "hop to matched 'input pattern'"},
      {"<Leader>k", ":HopLineMW<CR>", desc = "hop line multi window"},
      {"<Leader>j", ":HopLineStartMW<CR>", desc = "hop to vertical lines column after cursor"},
      {"<Leader>w", ":HopWordAC<CR>", desc = "hop to after cursor word"},
      {"<Leader>b", ":HopWordBC<CR>", desc = "hop to before cursor word"},
      {"f", ":HopChar2AC<CR>", desc = "hop to after cursor char in line"},
      {"F", ":HopChar2BC<CR>", desc = "hop to before cursor char in line"},
