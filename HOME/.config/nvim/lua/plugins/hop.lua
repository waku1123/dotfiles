...
return {
  ...
  keys = {
      ...
      { "<Leader>j", mode = { "n", "x", "o" }, "<cmd>HopLineStartMW<CR>", desc = "すべてのバッファで行単位で行頭にhop" },
      { "<Leader>w", mode = { "n", "x", "o" }, "<cmd>HopWordAC<CR>",      desc = "カーソルより後ろの単語頭にhop" },
      { "<Leader>e", mode = { "n" }, ":lua require('hop').hint_words({ direction = require('hop.hint').HintDirection.AFTER_CURSOR, hint_position = require('hop.hint').HintPosition.END })<CR>", desc = "カーソルより後ろの単語末尾にhop" },
      { "<Leader>ge", mode = { "n" }, ":lua require('hop').hint_words({ direction = require('hop.hint').HintDirection.BEFORE_CURSOR, hint_position = require('hop.hint').HintPosition.END })<CR>", desc = "カーソルより前の単語末尾にhop" },
      { "<Leader>b", mode = { "n", "x", "o" }, "<cmd>HopWordBC<CR>",      desc = "カーソルより前の単語頭にhop" },
