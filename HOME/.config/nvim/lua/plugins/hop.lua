...
return {
  ...
  keys = {
      ...
      { "<Leader>k", "<cmd>HopVertical<CR>",    desc = "縦方向にhop" },
      { "<Leader>j", "<cmd>HopLineStartMW<CR>", desc = "すべてのバッファで行単位で行頭にhop" },
      { "<Leader>w", "<cmd>HopWordAC<CR>",      desc = "カーソルより後ろの単語頭にhop" },
      { "<Leader>e", ":lua require('hop').hint_words({ direction = require('hop.hint').HintDirection.AFTER_CURSOR, hint_position = require('hop.hint').HintPosition.END })<CR>", desc = "カーソルより後ろの単語末尾にhop" },
      { "<Leader>ge", ":lua require('hop').hint_words({ direction = require('hop.hint').HintDirection.BEFORE_CURSOR, hint_position = require('hop.hint').HintPosition.END })<CR>", desc = "カーソルより前の単語末尾にhop" },
